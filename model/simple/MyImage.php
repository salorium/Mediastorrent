...
<path style="fill:url(#degrade); stroke:#FFFFFF; stroke-width:2px;" id="video-icon" d="M50,60.345v391.311h412V60.345H50z M137.408,410.862H92.354v-38.747h45.055V410.862z M137.408,343.278
...
';
        ...
        $im = new \Imagick ();
        $im->newimage(600, 600, new \ImagickPixel('#999999'), "jpeg");
        $im->compositeimage($im2, \Imagick::COMPOSITE_DEFAULT, 100, 100);
