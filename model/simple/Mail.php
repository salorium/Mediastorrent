...
class Mail extends \core\Model {
    ...
    static function activationMotDePasse($mdp,$login,$mail){
     ...
     <html>
      ...
      <body>
       <p>Bonjour '.$login.', vous venez de faire une demande de réinitialisation de mot de passe, pour activer ce nouveau mot de passe vous devez cliquer sur le liens en dessous.<br>Si vous n\'avez pas éffectué de réinistialisation de mot de passe, merci de ne pas prendre en compte ce mail.</p>
       <table>
        <tr>
