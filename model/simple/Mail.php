...
class Mail extends \core\Model {
    ...
    static function activationMotDePasse($mdp,$login,$mail){
     ...
     <html>
      ...
      <body>
       <p>Bonjour '.$login.',<br> vous venez de faire une demande de réinitialisation de mot de passe, pour activer ce nouveau mot de passe vous devez cliquer sur le liens en dessous.<br>Si vous n\'avez pas éffectué de réinistialisation de mot de passe, merci de ne pas prendre en compte ce mail.</p>
       <table>
        <tr>
         <td>Mot de passe :</td><td>'.$mdp.'</td>
        </tr>
        </table>
        <a href="'.BASE_URL.'">Active le mot de passe :'.$mdp.'</a>
      </body>
     </html>
     ';
