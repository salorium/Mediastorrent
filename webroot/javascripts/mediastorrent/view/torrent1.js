...
Torrent1.view = {
    ...
    listTorrent: {
        ...
        liste: function (torrent, cpt) {
            ...
            return '<fieldset title="Clef unique ' + torrent[28] + '\tType ' + Math.random() + '" id="' + torrent[27] + '" class="torrent ' + ($.inArray(torrent[27], Torrent1.model.listTorrent.selectionne) > -1 ? "torrentselect" : "") + '" idcpt="' + cpt + '"><legend><table><tr><td><svg title="' + state[0] + '" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="60px" height="60px"  viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve">' +
