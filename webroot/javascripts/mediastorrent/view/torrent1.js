                        ...
                        switch (e.which){
                            ...
                            case 3:
                                ...
                                if ( id > -1 && Torrent1.model.filesTorrent.selectionne.length > 1){
                                    ...
                                    var button = [];
                                    var subutton = [];
                                    subutton.push({nom:"Haute", dest: function(){Torrent1.controller.filesTorrent.priorite(2);}})
                                    subutton.push({nom:"Normal", dest: function(){Torrent1.controller.filesTorrent.priorite(1);}})
                                    subutton.push({nom:"Ne pas télécharger", dest: function(){Torrent1.controller.filesTorrent.priorite(0);}})
                        ...
                        switch (e.which){
                            ...
                            case 3:
                                ...
                                if ( id > -1 && Torrent1.model.filesTorrent.selectionne.length > 1){
                                    ...
                                    button.push({nom:"Priorité",dest : subutton});
                                    button.push({nom:"Télécharger",dest : function(){Torrent1.controller.filesTorrent.download($(e.currentTarget).attr("data-id"));}});
                                    if ( Base.model.path.ext(v[0]) == "avi" || Base.model.path.ext(v[0]) == "mp4" || Base.model.path.ext(v[0]) == "mkv"){
                                        button.push({nom:"Streaming",dest : function(){Torrent1.controller.filesTorrent.streaming($(e.currentTarget).attr("data-id"));}});
                                    }
                                    Base.model.pannelClicDroit.make(button, e.clientX,e.clientY);
                                }
                                break;
