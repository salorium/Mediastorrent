            ...
            success: function (response, textStatus, jqXHR) {
                ...
                if (response.showdebugger == "ok") {
                    $.each(response.file, function (k, v) {
                        //console.log(v);
                        $table.append('<tr><td>' + v.mediainfo.typequalite + '</td><td>' + (v.mediainfo.qualite ? v.mediainfo.qualite : "" ) + '</td><td><a href="' + Base.controller.makeUrlBase(v.hostname) + 'film/download/' + v.id + '/' + Base.model.utilisateur.login + '/' + Base.model.utilisateur.keyconnexion + '"><img width="30" src="' + Base.controller.makeUrlBase() + 'images/dl.svg"></a></td><td><a onclick="Film.streaming(\'' + v.id + '\',\'' + v.hostname + '\')"><img width="30" src="' + Base.controller.makeUrlBase() + 'images/streaming.svg"></a></td></tr>');
                    })
