!function (a, b, c, d) {
    ...
    var f = function (b) {
        var c = b.length;
        for (a("head"); c--;)0 === a("head").has("." + b[c]).length && a("head").append('<meta class="' + b[c] + '" />')
    };
    ...
    b.matchMedia = b.matchMedia || function (a) {
    ...
    }(jQuery), b.Foundation = {name: "Foundation", version: "5.2.1", media_queries: {small: g(".foundation-mq-small").css("font-family").replace(/^[\/\\'"]+|(;\s?})+|[\/\\'"]+$/g, ""), medium: g(".foundation-mq-medium").css("font-family").replace(/^[\/\\'"]+|(;\s?})+|[\/\\'"]+$/g, ""), large: g(".foundation-mq-large").css("font-family").replace(/^[\/\\'"]+|(;\s?})+|[\/\\'"]+$/g, ""), xlarge: g(".foundation-mq-xlarge").css("font-family").replace(/^[\/\\'"]+|(;\s?})+|[\/\\'"]+$/g, ""), xxlarge: g(".foundation-mq-xxlarge").css("font-family").replace(/^[\/\\'"]+|(;\s?})+|[\/\\'"]+$/g, "")}, stylesheet: a("<style></style>").appendTo("head")[0].sheet, global: {namespace: ""}, init: function (a, b, c, d, e) {
        var f = [a, c, d, e], h = [];
        if (this.rtl = /rtl/i.test(g("html").attr("dir")), this.scope = a || this.scope, this.set_namespace(), b && "string" == typeof b && !/reflow/i.test(b))this.libs.hasOwnProperty(b) && h.push(this.init_lib(b, f)); else for (var i in this.libs)h.push(this.init_lib(i, b));
        return a
        ...
        var b = this.global.namespace || a(".foundation-data-attribute-namespace").css("font-family");
        /false/i.test(b) || (this.global.namespace = b)
        ...
        for (g = (j || ":").split(";"), e = g.length; e--;)f = g[e].split(":"), /true/i.test(f[1]) && (f[1] = !0), /false/i.test(f[1]) && (f[1] = !1), c(f[1]) && (f[1] = -1 === f[1].indexOf(".") ? parseInt(f[1], 10) : parseFloat(f[1], 10)), 2 === f.length && f[0].length > 0 && (h[d(f[0])] = d(f[1]));
        return h
    ...
    Foundation.libs.abide = {name: "abide", version: "5.2.1", settings: {live_validate: !0, focus_on_invalid: !0, error_labels: !0, timeout: 1e3, patterns: {alpha: /^[a-zA-Z]+$/, alpha_numeric: /^[a-zA-Z0-9]+$/, integer: /^\d+$/, number: /-?(?:\d+|\d{1,3}(?:,\d{3})+)?(?:\.\d+)?/, card: /^(?:4[0-9]{12}(?:[0-9]{3})?|5[1-5][0-9]{14}|6(?:011|5[0-9][0-9])[0-9]{12}|3[47][0-9]{13}|3(?:0[0-5]|[68][0-9])[0-9]{11}|(?:2131|1800|35\d{3})\d{11})$/, cvv: /^([0-9]){3,4}$/, email: /^[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/, url: /(https?|ftp|file|ssh):\/\/(((([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-zA-Z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-zA-Z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-zA-Z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-zA-Z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-zA-Z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-zA-Z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?)(:\d*)?)(\/((([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)+(\/(([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(\#((([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|\/|\?)*)?/, domain: /^([a-zA-Z0-9]([a-zA-Z0-9\-]{0,61}[a-zA-Z0-9])?\.)+[a-zA-Z]{2,6}$/, datetime: /([0-2][0-9]{3})\-([0-1][0-9])\-([0-3][0-9])T([0-5][0-9])\:([0-5][0-9])\:([0-5][0-9])(Z|([\-\+]([0-1][0-9])\:00))/, date: /(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))/, time: /(0[0-9]|1[0-9]|2[0-3])(:[0-5][0-9]){2}/, dateISO: /\d{4}[\/\-]\d{1,2}[\/\-]\d{1,2}/, month_day_year: /(0[1-9]|1[012])[- \/.](0[1-9]|[12][0-9]|3[01])[- \/.](19|20)\d\d/, color: /^#?([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$/}, validators: {equalTo: function (a) {
        ...
        {
            var c = this, d = c.S(b).attr("novalidate", "novalidate");
            d.data(this.attr_name(!0) + "-init")
        }
        this.invalid_attr = this.add_namespace("data-invalid"), d.off(".abide").on("submit.fndtn.abide validate.fndtn.abide",function (a) {
            ...
            var d = a(this).closest("form").data(c.attr_name(!0) + "-init");
            d.live_validate === !0 && (clearTimeout(c.timer), c.timer = setTimeout(function () {
                c.validate([this], b)
            }.bind(this), d.timeout))
        })
    }, reset: function (b) {
        ...
        for (var b = a.getAttribute("name"), d = c.getElementsByName(b), e = d.length, f = !1, g = 0; e > g; g++)d[g].checked && (f = !0);
    ...
    "use strict";
    Foundation.libs.accordion = {name: "accordion", version: "5.2.1", settings: {active_class: "active", toggleable: !0}, init: function (a, b, c) {
        this.bindings(b, c)
    }, events: function () {
        var b = this, c = this.S;
        c(this.scope).off(".fndtn.accordion").on("click.fndtn.accordion", "[" + this.attr_name() + "] dd > a", function (d) {
            ...
            if (d.preventDefault(), c(this).closest("dl").is(e)) {
                if (j[0] == f[0] && i.toggleable)return k.toggleClass(i.active_class, !1), f.toggleClass(i.active_class, !1);
                g.removeClass(i.active_class), h.removeClass(i.active_class), f.addClass(i.active_class).parent().addClass(i.active_class)
            }
        })
    }, off: function () {
    }, reflow: function () {
    ...
    Foundation.libs.alert = {name: "alert", version: "5.2.1", settings: {animation: "fadeOut", speed: 300, callback: function () {
        ...
        a(this.scope).off(".alert").on("click.fndtn.alert", "[" + this.attr_name() + "] a.close", function (a) {
            ...
            a.preventDefault(), d[e.animation](e.speed, function () {
                c(this).trigger("close").remove(), e.callback()
            })
        })
    }, reflow: function () {
    }}
    ...
    Foundation.libs.clearing = {name: "clearing", version: "5.2.1", settings: {templates: {viewing: '<a href="#" class="clearing-close">&times;</a><div class="visible-img" style="display: none"><div class="clearing-touch-label"></div><img src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3D" alt="" /><p class="clearing-caption"></p><a href="#" class="clearing-main-prev"><span></span></a><a href="#" class="clearing-main-next"><span></span></a></div>'}, close_selectors: ".clearing-close", touch_label: "&larr;&nbsp;Swipe to Advance&nbsp;&rarr;", init: !1, locked: !1}, init: function (a, b, c) {
        ...
        if (!c.parent().hasClass("carousel")) {
            ...
            var d = this.S("#foundationClearingHolder"), e = c.data(this.attr_name(!0) + "-init"), f = c.detach(), g = {grid: '<div class="carousel">' + f[0].outerHTML + "</div>", viewing: e.templates.viewing}, h = '<div class="clearing-assembled"><div>' + g.viewing + g.grid + "</div></div>", i = this.settings.touch_label;
            Modernizr.touch && (h = a(h).find(".clearing-touch-label").html(i).end()), d.after(h).remove()
        }
    }, open: function (b, d, e) {
        function f() {
            setTimeout(function () {
        ...
        var h = this, i = a(c.body), j = e.closest(".clearing-assembled"), k = a("div", j).first(), l = a(".visible-img", k), m = a("img", l).not(b), n = a(".clearing-touch-label", ".clearing-blackout"), o = !1;
        m.error(function () {
            o = !0
    ...
    Foundation.libs.dropdown = {name: "dropdown", version: "5.2.1", settings: {active_class: "open", align: "bottom", is_hover: !1, opened: function () {
        ...
        var c = this, d = c.S;
        d(this.scope).off(".dropdown").on("click.fndtn.dropdown", "[" + this.attr_name() + "]",function (a) {
            var b = d(this).data(c.attr_name(!0) + "-init") || c.settings;
            a.preventDefault(), (!b.is_hover || Modernizr.touch) && c.toggle(d(this))
        ...
        var b = this;
        a.each(function () {
            b.S(this).hasClass(b.settings.active_class) && (b.S(this).css(Foundation.rtl ? "right" : "left", "-99999px").removeClass(b.settings.active_class), b.S(this).trigger("closed", [a]))
        })
    }, closeall: function () {
        var b = this;
        ...
        this.css(a.addClass(this.settings.active_class), b), a.trigger("opened", [a, b])
    }, data_attr: function () {
        ...
        if (this.clear_idx(), this.small()) {
            ...
            a.attr("style", "").removeClass("drop-left drop-right drop-top").css({position: "absolute", width: "95%", "max-width": "none", top: c.top}), a.css(Foundation.rtl ? "right" : "left", "2.5%")
        } else {
    ...
    "use strict";
    Foundation.libs.equalizer = {name: "equalizer", version: "5.2.1", settings: {use_tallest: !0, before_height_change: a.noop, after_height_change: a.noop}, init: function (a, b, c) {
        this.bindings(b, c), this.reflow()
    }, events: function () {
        this.S(b).off(".equalizer").on("resize.fndtn.equalizer", function () {
            this.reflow()
        }.bind(this))
    }, equalize: function (b) {
        var c = !1, d = b.find("[" + this.attr_name() + "-watch]"), e = d.first().offset().top, f = b.data(this.attr_name(!0) + "-init");
    ...
    Foundation.libs.interchange = {name: "interchange", version: "5.2.1", cache: {}, images_loaded: !1, nodes_loaded: !1, settings: {load_attr: "interchange", named_queries: {"default": "only screen", small: Foundation.media_queries.small, medium: Foundation.media_queries.medium, large: Foundation.media_queries.large, xlarge: Foundation.media_queries.xlarge, xxlarge: Foundation.media_queries.xxlarge, landscape: "only screen and (orientation: landscape)", portrait: "only screen and (orientation: portrait)", retina: "only screen and (-webkit-min-device-pixel-ratio: 2),only screen and (min--moz-device-pixel-ratio: 2),only screen and (-o-min-device-pixel-ratio: 2/1),only screen and (min-device-pixel-ratio: 2),only screen and (min-resolution: 192dpi),only screen and (min-resolution: 2dppx)"}, directives: {replace: function (b, c, d) {
        ...
        if (f != c) {
            var g = "/^.(.jpg|.jpeg|.png|.gif|.tiff|.bmp)??|#?./";
            return new RegExp(g, "i").test(c) ? (a(b).css("background-image", "url(" + c + ")"), b.data("interchange-last-path", c), d(c)) : a.get(c, function (a) {
    ...
    Foundation.libs.joyride = {name: "joyride", version: "5.2.1", defaults: {expose: !1, modal: !0, tip_location: "bottom", nub_position: "auto", scroll_speed: 1500, scroll_animation: "linear", timer: 0, start_timer_on_click: !0, start_offset: 0, next_button: !0, tip_animation: "fade", pause_after: [], exposed: [], tip_animation_fade_speed: 300, cookie_monster: !1, cookie_name: "joyride", cookie_domain: !1, cookie_expires: 365, tip_container: "body", tip_location_patterns: {top: ["bottom"], bottom: [], left: ["right", "top", "bottom"], right: ["left", "top", "bottom"]}, post_ride_callback: function () {
        ...
        var c = b.$li.attr(this.add_namespace("data-button")) || b.$li.attr(this.add_namespace("data-text")), d = b.$li.attr("class"), e = a(this.tip_template({tip_class: d, index: b.index, button_text: c, li: b.$li}));
        ...
        var c, d;
        c = a(b).height() / 2, d = Math.ceil(this.settings.$target.offset().top - c + this.settings.$next_tip.outerHeight()), 0 != d && a("html, body").animate({scrollTop: d}, this.settings.scroll_speed, "swing")
    }, paused: function () {
    ...
    "use strict";
    Foundation.libs["magellan-expedition"] = {name: "magellan-expedition", version: "5.2.1", settings: {active_class: "active", threshold: 0, destination_threshold: 20, throttle_delay: 30}, init: function (a, b, c) {
        Foundation.inherit(this, "throttle"), this.bindings(b, c)
    }, events: function () {
        var c = this, d = c.S, e = c.settings;
        c.set_expedition_position(), d(c.scope).off(".magellan").on("click.fndtn.magellan", "[" + c.add_namespace("data-magellan-arrival") + '] a[href^="#"]',function (d) {
            d.preventDefault();
            var e = a(this).closest("[" + c.attr_name() + "]"), f = (e.data("magellan-expedition-init"), this.hash.split("#").join("")), g = a("a[name=" + f + "]");
            0 === g.length && (g = a("#" + f));
            var h = g.offset().top;
            "fixed" === e.css("position") && (h -= e.outerHeight()), a("html, body").stop().animate({scrollTop: h}, 700, "swing", function () {
                b.location.hash = "#" + f
            })
        ...
        a("[" + this.attr_name() + "=fixed]", c.scope).each(function () {
            ...
            if (d >= e) {
                ...
                0 === f.length && (f = b.clone(), f.removeAttr(c.attr_name()), f.attr(c.add_namespace("data-magellan-expedition-clone"), ""), b.before(f)), b.css({position: "fixed", top: 0})
        ...
        var d = this, e = b.data(d.attr_name(!0) + "-init"), f = c + e.destination_threshold;
        return b.find("[" + d.add_namespace("data-magellan-arrival") + "]").map(function () {
            var b = a(this).data(d.data_attr("magellan-arrival")), c = a("[" + d.add_namespace("data-magellan-destination") + "=" + b + "]");
            if (c.length > 0) {
                var e = c.offset().top;
                return{destination: c, arrival: a(this), top_offset: e, viewport_offset: f}
            }
        }).sort(function (a, b) {
    ...
    "use strict";
    Foundation.libs.offcanvas = {name: "offcanvas", version: "5.2.1", settings: {}, init: function () {
        this.events()
    }, events: function () {
        var c = this.S;
        c(this.scope).off(".offcanvas").on("click.fndtn.offcanvas", ".left-off-canvas-toggle",function (a) {
            a.preventDefault(), c(this).closest(".off-canvas-wrap").toggleClass("move-right")
        }).on("click.fndtn.offcanvas", ".exit-off-canvas",function (a) {
            a.preventDefault(), c(".off-canvas-wrap").removeClass("move-right")
        }).on("click.fndtn.offcanvas", ".left-off-canvas-menu a",function (d) {
            d.preventDefault();
            var e = a(this).attr("href");
            c(".off-canvas-wrap").on("transitionend webkitTransitionEnd oTransitionEnd", function () {
                b.location = e, c(".off-canvas-wrap").off("transitionend webkitTransitionEnd oTransitionEnd")
            }), c(".off-canvas-wrap").removeClass("move-right")
        }).on("click.fndtn.offcanvas", ".right-off-canvas-toggle",function (a) {
            a.preventDefault(), c(this).closest(".off-canvas-wrap").toggleClass("move-left")
        }).on("click.fndtn.offcanvas", ".exit-off-canvas",function (a) {
            a.preventDefault(), c(".off-canvas-wrap").removeClass("move-left")
        }).on("click.fndtn.offcanvas", ".right-off-canvas-menu a", function (d) {
            d.preventDefault();
            var e = a(this).attr("href");
            c(".off-canvas-wrap").on("transitionend webkitTransitionEnd oTransitionEnd", function () {
                b.location = e, c(".off-canvas-wrap").off("transitionend webkitTransitionEnd oTransitionEnd")
            }), c(".off-canvas-wrap").removeClass("move-left")
        })
    }, reflow: function () {
    }}
}(jQuery, this, this.document), function (a, b, c) {
    ...
    var d = function () {
        ...
        var h, i, j, k, l, m = this, n = d, o = 0;
        m.cache = {}, m.slides = function () {
            return n.children(e.slide_selector)
        }, m.slides().first().addClass(e.active_slide_class), m.update_slide_number = function (b) {
            ...
            m.build_markup(), e.timer && (m.cache.timer = m.create_timer(), Foundation.utils.image_loaded(this.slides().children("img"), m.cache.timer.start)), "fade" === e.animation && n.addClass("fade"), l = new g(e, n), h.on("click", "." + e.next_class, m.next), h.on("click", "." + e.prev_class, m.prev), h.on("click", "[data-orbit-slide]", m.link_bullet), h.on("click", m.toggle_timer), e.swipe && n.on("touchstart.fndtn.orbit",function (a) {
                m.cache.animating || (a.touches || (a = a.originalEvent), m.cache.start_page_x = a.touches[0].pageX, m.cache.start_page_y = a.touches[0].pageY, m.cache.start_time = (new Date).getTime(), m.cache.delta_x = 0, m.cache.is_scrolling = null, m.cache.direction = null, m.stop_timer())
            ...
            }), a(c).on("click", "[data-orbit-link]", m.link_custom), a(b).on("resize", m.compute_dimensions), Foundation.utils.image_loaded(this.slides().children("img"), m.compute_dimensions), Foundation.utils.image_loaded(this.slides().children("img"), function () {
                h.prev(".preloader").css("display", "none"), m.update_slide_number(0), m.update_active_link(0), n.trigger("ready.fndtn.orbit")
            })
        }, m.init()
    }, f = function (a, b, c) {
        ...
        this.update_progress = function (a) {
            ...
            clearTimeout(e), a.addClass(b.timer_paused_class), i = -1, f.update_progress(0), f.start()
        }, this.start = function () {
        ...
        this.next = function (a, d, e) {
            d.on(c, function () {
                d.unbind(c), a.removeClass("active animate-out"), d.removeClass("animate-in"), e()
            }), b.children().css({transform: "", transitionDuration: ""}), a.addClass("animate-out"), d.addClass("animate-in")
        }, this.prev = function (a, b, d) {
            b.on(c, function () {
                b.unbind(c), a.removeClass("active animate-out"), b.removeClass("animate-in"), d()
            }), a.css({transform: "", transitionDuration: ""}).addClass("animate-out"), b.css({transform: "", transitionDuration: ""}).addClass("animate-in")
        }
    };
    ...
    Foundation.libs.reveal = {name: "reveal", version: "5.2.1", locked: !1, settings: {animation: "fadeAndPop", animation_speed: 250, close_on_background_click: !0, close_on_esc: !0, dismiss_modal_class: "close-reveal-modal", bg_class: "reveal-modal-bg", open: function () {
        ...
        0 === this.S("." + this.settings.bg_class).length && (this.settings.bg = a("<div />", {"class": this.settings.bg_class}).appendTo("body").hide()), this.settings.bg.filter(":visible").length > 0 ? this.hide(this.settings.bg) : this.show(this.settings.bg)
    }, show: function (c, d) {
        if (d) {
    ...
    Foundation.libs.slider = {name: "slider", version: "5.2.1", settings: {start: 0, end: 100, step: 1, initial: null, display_selector: "", on_change: function () {
        ...
        a(this.scope).off(".slider").on("mousedown.fndtn.slider touchstart.fndtn.slider pointerdown.fndtn.slider", "[" + c.attr_name() + "] .range-slider-handle",function (b) {
            c.cache.active || c.set_active_slider(a(b.target))
        }).on("mousemove.fndtn.slider touchmove.fndtn.slider pointermove.fndtn.slider",function (a) {
            c.cache.active && (a.preventDefault(), c.calculate_position(c.cache.active, a.pageX || a.originalEvent.touches[0].clientX || a.currentPoint.x))
        ...
        requestAnimationFrame(function () {
            var a = d.limit_to((c - g) / f, 0, 1), h = d.normalized_value(a, e.start, e.end, e.step);
            d.set_ui(b, h)
        })
    }, set_ui: function (b, c) {
        ...
        this.set_translate(b, h), b.siblings(".range-slider-active-segment").css("width", i + "%"), b.parent().attr(this.attr_name(), c), b.parent().trigger("change"), b.parent().children("input[type=hidden]").val(c), "" != d.input_id && a(d.display_selector).each(function () {
        ...
        var c = a.data(b.children(".range-slider-handle")[0], "settings"), d = c.initial ? c.initial : Math.floor(.5 * (c.end - c.start) / c.step) * c.step, e = b.children(".range-slider-handle");
        this.set_ui(e, d)
        ...
        b.S("[" + this.attr_name() + "]").each(function () {
            ...
            b.initialize_settings(c), d ? b.set_ui(a(c), parseInt(d)) : b.set_initial_position(a(this))
        })
    }}
}(jQuery, this, this.document), function (a, b, c, d) {
    "use strict";
    Foundation.libs.tab = {name: "tab", version: "5.2.1", settings: {active_class: "active", callback: function () {
    }, deep_linking: !1, scroll_to_content: !0}, default_tab_hashes: [], init: function (a, b, c) {
        var d = this, e = this.S;
        ...
        c(this.scope).off(".tab").on("click.fndtn.tab", "[" + this.attr_name() + "] > dd > a", function (b) {
            b.preventDefault(), b.stopPropagation(), a.toggle_active_tab(c(this).parent())
    ...
    "use strict";
    Foundation.libs.tooltip = {name: "tooltip", version: "5.2.1", settings: {additional_inheritable_classes: [], tooltip_class: ".tooltip", append_to: "body", touch_close_text: "Tap To Close", disable_for_touch: !1, hover_delay: 200, tip_template: function (a, b) {
        ...
        var c = this, d = c.S;
        c.create(this.S(b)), a(this.scope).off(".tooltip").on("mouseenter.fndtn.tooltip mouseleave.fndtn.tooltip touchstart.fndtn.tooltip MSPointerDown.fndtn.tooltip", "[" + this.attr_name() + "]:not(a)",function (b) {
        ...
        this.S(this.scope).off(".fndtn.tooltip"), this.S(this.settings.tooltip_class).each(function (c) {
            a("[" + b.attr_name() + "]").get(c).attr("title", a(this).text())
        }).remove()
    }, reflow: function () {
    }}
}(jQuery, this, this.document), function (a, b, c) {
    "use strict";
    Foundation.libs.topbar = {name: "topbar", version: "5.2.1", settings: {index: 0, sticky_class: "sticky", custom_back_text: !0, back_text: "Back", is_hover: !0, mobile_show_parent_link: !1, scrolltop: !0, sticky_on: "all"}, init: function (b, c, d) {
        ...
        d(this.scope).off(".topbar").on("click.fndtn.topbar", "[" + this.attr_name() + "] .toggle-topbar",function (a) {
            ...
            var b = d(this), e = d(a.target), f = b.closest("[" + c.attr_name() + "]"), g = f.data(c.attr_name(!0) + "-init");
            return e.data("revealId") ? void c.toggle() : void(c.breakpoint() || (!g.is_hover || Modernizr.touch) && (a.stopImmediatePropagation(), b.hasClass("hover") ? (b.removeClass("hover").find("li").removeClass("hover"), b.parents("li.hover").removeClass("hover")) : (b.addClass("hover"), "A" === e[0].nodeName && e.parent().hasClass("has-dropdown") && a.preventDefault())))
            ...
            b.length > 0 || d("[" + c.attr_name() + "] li").removeClass("hover")
