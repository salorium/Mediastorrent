...
<nav class="top-bar" data-topbar="">
    <!-- Title -->
    <ul class="title-area">
        <li class="name"><h1><a href="#"><?= \config\Conf::$user["user"]->login." (".\config\Conf::$user["user"]->role.")";?></a></h1></li>
    ...
    <section class="top-bar-section">
        ...
        <ul class="left">
            ...
            <li class="divider"></li>
            <li class="has-dropdown"><a><img width="30px"  title="Série" src="<?=BASE_URL?>images/serie.svg?color=rgba(240,240,240,1)"/></a>
            ...
            <li class="divider"></li>
            <li class="has-dropdown"><a><img width="30px"  title="Musique" src="<?=BASE_URL?>images/musique.svg?color=rgba(240,240,240,1)"/></a>
            ...
            <li class="has-form">
                <div class="row collapse">
                    ...
                    <div class="large-4 small-3 columns">
                        <a href="#" class="alert button expand"><img width="18px" src="<?=BASE_URL?>images/search.svg?color=rgba(240,240,240,1)"></a>
                    </div>
                </div>
            </li>
